...
function Register() {
  ...
  const validate = () => {
    ...
    if (!(file instanceof Blob)) {
      newErrors.file = "The file is not a Blob";
    }
  ...
  async function convertFileToBase64(file) {
    return new Promise((resolve, reject) => {
      if (!file) {
        ...
        const allowedTypes = ["image/jpeg", "image/png", "image/gif"];
        if (!allowedTypes.includes(file.type)) {
          reject("Only JPEG, PNG and GIF files are allowed");
        }
        const maxSize = 1 * 1024 * 1024; // 1MB
        if (file.size > maxSize) {
...
//     return new Promise((resolve, reject) => {
//       if (!(file instanceof Blob)) {
//         reject(new Error("The file is not a Blob"));
//       }
//       const reader = new FileReader();
//       reader.onloadend = () => resolve(reader.result);
//       reader.onerror = reject;
...
//           ))}
//           {errors.selectedHobbies && (
//             <span className="text-danger">{errors.selectedHobbies}</span>
//           )}
//         </div>
...
//           </div>
//           {errors.selectDate && (
//             <span className="text-danger">{errors.selectDate}</span>
//           )}
//         </div>
...
//           </select>
//           {errors.countriesid && (
//             <span className="text-danger">{errors.countriesid}</span>
//           )}
//         </div>
...
//           </select>
//           {errors.statesid && (
//             <span className="text-danger">{errors.statesid}</span>
//           )}
//         </div>
...
//           </select>
//           {errors.citiesid && (
//             <span className="text-danger">{errors.citiesid}</span>
//           )}
//         </div>
